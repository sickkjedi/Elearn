...
urlpatterns = [
    ...
    path('courses/edit_course/elements/html/edit_element/<int:pk>', views.EditHTMLElement.as_view(), name='edit_html_element'),
    ...
    path('courses/edit_course/elements/reflection/edit_element/<int:pk>', views.EditReflectionElement.as_view(), name='edit_reflection_element'),
